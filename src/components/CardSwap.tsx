...
export const Card = forwardRef<HTMLDivElement, CardProps>(({ customClass, ...rest }, ref) => (
  <div
    ...
    {...rest}
    className={cn(
      "absolute top-1/2 left-1/2 rounded-3xl border border-border bg-panel shadow-2xl [transform-style:preserve-3d] [will-change:transform] [backface-visibility:hidden] glass-panel",
      customClass,
      rest.className
    )}
  />
